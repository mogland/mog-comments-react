/*
 * @FilePath: /nx-comments-react/src/index.tsx
 * @author: Wibus
 * @Date: 2022-07-01 19:50:23
 * @LastEditors: Wibus
 * @LastEditTime: 2022-08-26 14:18:27
 * Coding With IU
 */
...
export const Comments: FC<ICommentsFC> = ({ type, path, id, apiClient }) => {
        ...
        <div className="relative">
          <div className={clsx(styles.tlLine)} />
          {
            children.length && children.map((item: any, index: number) => {
              return (
                <div className={clsx(styles.replyBox)} id={`${index}`}>
      ...
      <div className={clsx(styles["comments"])}>
        ...
        <form action="post" className={clsx(styles['form'])} onSubmit={async (e) => {
          ...
          <div className={clsx(styles["submitBtn"])}>
            <a href="https://guides.github.com/features/mastering-markdown/" className={clsx(styles.markdownSupport)}>
